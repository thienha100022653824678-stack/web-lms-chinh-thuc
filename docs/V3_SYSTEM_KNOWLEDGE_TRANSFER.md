...
- **Thứ tự hiện thực hóa:** Phase 0 ✅ → Phase 1 ✅ (⑦ migration tooling + CI schema-drift gate — repo tooling DONE 2026-07-15, `docs/V3_PHASE_1_MIGRATION_TOOLING.md`; baseline B `db pull` owner-only pending) → Phase 2 ✅ (① RLS + key tiering + RPC write path — repo DONE 2026-07-15, `docs/V3_PHASE_2_RLS_KEY_TIERING.md`; apply `migration_v3_rls_policies.sql` on B after canary = owner-pending) → Phase 3 ✅ (④ outbox backbone canonical + ⑤ worker reuse — repo DONE 2026-07-15, `docs/V3_PHASE_3_OUTBOX_BACKBONE.md`; apply `migration_v3_outbox_dead_letters.sql` on B = owner-pending) → Phase 4 ✅ (② unified opaque session + ③ server-minted device credential — repo DONE 2026-07-15, `docs/V3_PHASE_4_SESSION_UNIFY.md`; Portal lockstep = owner-merged PR proposal `docs/V3_PORTAL_PR_PROPOSAL_SESSION.md`) → Phase 5 ✅ (⑥ router split + edge read-only — repo DONE 2026-07-15, `docs/V3_PHASE_5_ROUTER_EDGE.md`; v1/v2 delegate to legacy router unchanged, code-only) → Phase 6 ✅ (⑪ structured logs + metrics + tracing — repo DONE 2026-07-15, `docs/V3_PHASE_6_OBSERVABILITY.md`; code-only) → Phase 7 ✅ (⑨ diagnostics dashboard + modular-FE pattern — repo DONE 2026-07-15, `docs/V3_PHASE_7_FE_MODULAR.md`; big admin-page rewrite deferred to behind-v3-gating) → Phase 8 ✅ (⑩ shared event-schema package — repo DONE 2026-07-15, `docs/V3_PHASE_8_TYPESCRIPT_MONOREPO.md`; full JS→TS + pnpm workspace deferred to behind-v3-gating) → Phase 9 (⑫ signed-URL/DRM) → Phase 10 (⑧ cleanup, cuối cùng, owner duyệt).
