...
test("security: V2_GLOBAL_ONE_DEVICE_ENABLED only appears in expected files", async () => {
  ...
  const allowed = new Set([
    ...
    "docs/superpowers/plans/2026-07-15-v3-phase3-outbox-backbone.md",
    "docs/superpowers/plans/2026-07-15-v3-phase4-session-unify.md",
    "docs/superpowers/plans/2026-07-15-v3-phase5-router-edge.md"
  ]);
