...
INSERT INTO public.courses(id,slug,title,subtitle,active,is_published,sort_order,sales_site,learning_course_slug,lms_tenant,drive_folder_id,raw_data)
VALUES
...
ON CONFLICT(slug) DO UPDATE SET
 ...
 lms_tenant=excluded.lms_tenant,drive_folder_id=excluded.drive_folder_id,raw_data=excluded.raw_data,updated_at=now();

INSERT INTO public.orders(
  id,order_code,course_slug,learning_course_slug,sales_site,lms_tenant,status,customer_email,raw_data
)
VALUES
('44000000-0000-4000-8000-000000000001','PREVIEW-YEUNAUAN-001',
 'preview-yeunauan-course-a','preview-yeunauan-course-a','yeunauan','yeunauan',
 'approved','student-a.yeunauan@example.test','{"synthetic":true}'),
('44000000-0000-4000-8000-000000000002','PREVIEW-YEUBEP-001',
 'preview-yeubep-course-a','preview-yeubep-course-a','yeubep','yeubep',
 'approved','student-b.yeubep@example.test','{"synthetic":true}')
ON CONFLICT(order_code) DO UPDATE SET
 course_slug=excluded.course_slug,learning_course_slug=excluded.learning_course_slug,
 sales_site=excluded.sales_site,lms_tenant=excluded.lms_tenant,status=excluded.status,
 customer_email=excluded.customer_email,raw_data=excluded.raw_data,updated_at=now();
