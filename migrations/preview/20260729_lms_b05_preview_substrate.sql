...
BEGIN
  FOREACH v_name IN ARRAY ARRAY[
    'courses','lessons','site_config','students','lesson_progress',
...
REVOKE ALL ON public.courses, public.lessons, public.site_config, public.students,
...
GRANT ALL ON public.courses, public.lessons, public.site_config, public.students,
  public.student_enrollments, public.lesson_progress, public.admin_audit_logs,
  public.drive_permission_logs, public.drive_sync_queue, public.drive_admin_accounts,
